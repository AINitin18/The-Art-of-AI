# The Art of AI — Code Examples (Official Repository)

# The-Art-of-AI
AI is often taught as a collection of algorithms and tools. This book takes a different path. It treats AI as an art  an art of thinking with data, reasoning with uncertainty, and designing intelligent systems responsibly. From statistics and mathematics to machine learning, deep learning, and generative AI, 
...
- 📘 **Chapter-wise notebooks / scripts** (same order as the book)
- 🧩 **Tiny datasets** (10–20 rows) used for learning and practice
- ✅ **Exercises + solutions** (where applicable)
- 🧪 **Train/Test examples** with unseen data
- 🧠 **Mini projects** that connect concepts to real-world thinking
...
- I strongly recommend this learning method:
- Read the chapter (Why → What → How)
- Run the code “as-is” once
- Change only one thing
- Observe the output and learn
- Repeat
...
Agentic patterns (Planner, Router, Executor)

## Acknowledgements
This book is the result of a long learning journey shaped by practice, curiosity, mentorship, and continuous exploration. I would like to express my sincere gratitude to the organizations, educators, authors, researchers, and professional communities that helped strengthen my understanding of Artificial Intelligence and its practical applications.
I have learned from my work and experience within IBM AI and from the broader innovation culture that encourages continuous growth, experimentation, and solution thinking. I am also grateful for the knowledge and structured learning support I gained through MIT AI Product Development programs, LearnBay, MIT Media Lab inspirations, and the highly practical educational contributions of Jason Brownlee through his mastery-based books and learning materials.
Each of these influences contributed in different ways—some through fundamentals, some through product thinking, some through practical implementation, and some through the discipline of learning by doing.
I am equally thankful to the many colleagues, mentors, domain experts, and learners who inspired me through discussions, collaboration, and real-world challenges. Their questions, feedback, and shared experiences helped shape the practical teaching style of this book.
Most importantly, I would like to thank every learner who continues to believe that even the most advanced technology can be understood when explained with clarity, patience, and purpose.
...
What matters most is that you continue with intention. Build small projects. Rework the examples from this book. Change the data. Experiment with prompts. Compare models. Try local LLMs. Build a small retrieval system. Create a mini AI assistant for your own domain. The strongest learning happens when ideas move from reading into implementation.
